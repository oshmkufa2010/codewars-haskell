...
evalSKI :: SKI a -> a
evalSKI (Ap sab sa) = (evalSKI sab) (evalSKI sa)
...
rev :: SKI (a -> (a -> b) -> b)
rev = S `Ap` (K `Ap` (S `Ap` I)) `Ap` K

comp :: SKI ((b -> c) -> (a -> b) -> (a -> c))
comp = S `Ap` (K `Ap` S) `Ap` K

flip' :: SKI ((a -> b -> c) -> (b -> a -> c))
flip' = S `Ap` (S `Ap` (K `Ap` S) `Ap` (S `Ap` (K `Ap` K) `Ap` S)) `Ap` (K `Ap` K)

rotr :: SKI (a -> (c -> a -> b) -> c -> b)
rotr = S `Ap` (K `Ap` (S `Ap` S)) `Ap` (S `Ap` (K `Ap` K) `Ap` K)

rotv :: SKI (a -> b -> (a -> b -> c) -> c)
rotv = S `Ap` (S `Ap` (K `Ap` S) `Ap` (S `Ap` (K `Ap` K) `Ap` (S `Ap` (K `Ap` S) `Ap` (S `Ap` (K `Ap` (S `Ap` I)) `Ap` K)))) `Ap` (K `Ap` K)
...
and' = S `Ap` S `Ap` (K `Ap` (K `Ap` false))

or' :: SKI (Bool' (Bool' a) -> Bool' a -> Bool' a)
or' = S `Ap` (S `Ap` (K `Ap` K) `Ap` (S `Ap` I `Ap` (K `Ap` true))) `Ap` I

xor' :: SKI (Bool' (Bool' a) -> Bool' a -> Bool' a)
xor' = S `Ap` (S `Ap` (K `Ap` S) `Ap` (S `Ap` (S `Ap` (K `Ap` S) `Ap` K) `Ap` (K `Ap` not'))) `Ap` (K `Ap` I)
